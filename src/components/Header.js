    ...
    return (
        <div className={styles.mainWrapper}>
            ...
            <div className={styles.descWrapper}>
                ...
                <p>If you make a loss, this can be carried forward - click on the help icon form more information. If your expenses are under £1,000, we will apply a £1,000 trading allowance instead.</p>
            </div>
            <Expenses />
            <ExpenseForm />
        </div>
